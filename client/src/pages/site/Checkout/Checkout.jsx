          ...
          <div class=" col-lg-6 col-md-12 ">
            <div class="card">
              <div class="card-body">
                ...
                <p>
                  <a href="account-create.html">Login</a> or{" "}
                  <a href="account-create.html">Register</a> for faster payment.
                </p>
                <div class="row mt-2">
                  <div class="col-sm-9">
              ...
              <div class="card-body">
                ...
                <div class="clearfix">
                  <input
                    ...
                    type="checkbox"
                  />
                  <label for="formcheckoutCheckbox2">
          ...
          <div class=" col-lg-6 col-md-12 mt-2 mt-md-0">
            ...
            <div class="card">
              <div class="card-body">
                <h3>Order Comment</h3>
                <textarea
                  class="form-control form-control--sm textarea--height-200"
                  placeholder="Place your comment here"
                ></textarea>
                <div class="card-text-info mt-2">
                  <p>
                    *Savings include promotions, coupons, rueBUCKS, and shipping
                    (if applicable).
                  </p>
                </div>
              </div>
            ...
            <div class="cart-table cart-table--sm pt-3 pt-md-0">
              ...
              <div class="cart-table-prd">
                ...
                <div class="cart-table-prd-content-wrap">
                  ...
                  <div class="cart-table-prd-price-total">$352.00</div>
                </div>
              </div>
              <div class="cart-table-prd">
                <div class="cart-table-prd-image">
                ...
                <div class="cart-table-prd-content-wrap">
                  <div class="cart-table-prd-info">
                    <h2 class="cart-table-prd-name">
                      <a href="product.html">Cascade Casual Shirt</a>
                    </h2>
                  </div>
                  <div class="cart-table-prd-qty">
                    <div class="qty qty-changer">
                  ...
                  <div class="cart-table-prd-price-total">$142.00</div>
                </div>
              </div>
            </div>
          </div>
